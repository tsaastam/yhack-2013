...
foo = function(city, ccode) {
  $.ajax({
            url: getExpediaUrl(city, ccode),
            dataType: 'jsonp',
            jsonp: 'callback',
            jsonpCallback: 'getHotelInfo'
  });
}
...
flickrData = function(city, ccode) {
  $.YQL('select * from flickr.photos.search(30) where (text="' + city +', ' + ccode+ '" and sort="interestingness-desc" and extras="url_t" and api_key="881c7c2901162e2a11efa3980a16553d")', function(res) {
